...
//let ancientscripts = filter(SCRIPTS, element => element.year<=0);
//console.log(ancientscripts.map(e => e.name));

let averageyear = SCRIPTS.reduce((a,b)=>a + b.year, 0)/SCRIPTS.reduce((a,b)=> a+1 , 0 );
